...
import 'package:flutter_app/pages/places_list_tile.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class SelectOriginPlacePage extends StatefulWidget {
  const SelectOriginPlacePage({super.key});

  @override
  State<SelectOriginPlacePage> createState() => Select_OriginStatePlacePage();
}

class Select_OriginStatePlacePage extends State<SelectOriginPlacePage> {
